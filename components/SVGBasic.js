...
class SVGBasic extends Component {
  render() {
	...
	<svg xmlns="http://www.w3.org/2000/svg" version="1.1">
        ...
        <Image
          source={{
            uri:
              "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/SVG_example_markup_grid.svg/391px-SVG_example_markup_grid.svg.png"
          }}
        ...
        <T>
          - Positions are then measured in pixels from the top left corner, with
          the positive x direction being to the right, and the positive y
          direction being to the bottom.
        </T>
        <Image
          source={{
            uri: "https://www.w3.org/TR/SVG/images/coords/InitialCoords.png"
          }}
  ...
  <Svg height="100" width="100">
    <Path d="M0 100 200 100" />
        ...
        <T>
          - Components: Circle, Ellipse, G, LinearGradient, RadialGradient,
          Line, Path, Polygon, Polyline, Rect, Symbol, Text, Use, Defs, Stop
        </T>
  ...
  />
        ...
        <T>
          Draw complicated logo with react-native-svg (Circle, Path, Polygon)
        </T>
        <CopyRight />

        <T heading>Path element</T>
        <T>
          - The attribute d contains a seriers of commands and parameters in the
        ...
        <View>
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCell}>
              <Text>
                moveto: Move the pen to a new location. No line is drawn. All
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCell}>
              <Text>
                horizontal lineto: Draw a horizontal line from the current point
                to x.
              </Text>
            </View>
          </View>
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCell}>
              <Text>
                vertical lineto: Draw a horizontal line from the current point
                to y.
              </Text>
            </View>
          </View>
    ...
    />
        ...
        >
          <Path
            d={`M${deviceWidth / 2} 0 ${deviceWidth / 2} 100`}
            strokeWidth="2"
            stroke="red"
          />
          <Path
            d={`M0 50 ${deviceWidth} 50`}
            stroke="blue"
            strokeWidth="2"
            strokeDasharray="2,2"
          />
